...
LDLIBSOPTIONS=-L../../Equilibrium/dist/Release/Cygwin_4.x-Windows -lEquilibrium

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/testesubstancia.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/testesubstancia.exe: ../../Equilibrium/dist/Release/Cygwin_4.x-Windows/libEquilibrium.dll
...
${OBJECTDIR}/TesteSubstancia.o: nbproject/Makefile-${CND_CONF}.mk TesteSubstancia.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../Equilibrium/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TesteSubstancia.o TesteSubstancia.cpp

# Subprojects
.build-subprojects:
	cd ../../Equilibrium && ${MAKE}  -f Makefile CONF=Release
...
# Subprojects
.clean-subprojects:
	cd ../../Equilibrium && ${MAKE}  -f Makefile CONF=Release clean
